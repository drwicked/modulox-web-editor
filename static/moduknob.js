...
//------------------------------------------------------------------
// DÃ©clenchÃ© quand on clique quelque part dans le premier tab
//------------------------------------------------------------------
function onClick(e){
	_mouse.x = e.layerX;
	_mouse.y = e.layerY ;
...
function moduknobDropped(e){
	if(isTaken) {
		...
		console.log("module placed : " + module_placed);
		if(module_placed) document.getElementById("Set_text").innerHTML = "Tous les modules sont placés. Aller dans l'tab -MIDI- pour paramétrer les modules.";
...
$(document).ready(function () {
	...
	$("#tab_Set").click(changeSet);
	$("#tab_MIDI").click(changeMIDI);
//1111111111111111111
	$("#tab_Console").click(changeConsole);
	$("#tab_Sequence").click(changeSequence);
	$("#tab_Arpegio").click(changeArpegio);
	$("#tab_Module").click(changeModule);
});
function unlock(){
	$.unblockUI();
}
...
function changeMIDI()
{
	...
	if(!module_placed)
	{
		document.getElementById("MIDI_text").innerHTML = "Not all modules are placed";
	}
	else
	{
		document.getElementById("MIDI_text").innerHTML = "Click on an encoder to modify its parameters";
	}
}
//1111111111111111111
